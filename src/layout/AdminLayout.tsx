...
const Icons = {
  ...
  Newspaper: () => (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 20H5a2 2 0 01-2-2V7a2 2 0 012-2h11a2 2 0 012 2v11m0 2a2 2 0 002-2V9a2 2 0 00-2-2M9 9h6M9 13h6M9 17h3" />
    </svg>
  ),
  Conversation: () => (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
export function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const menuItems = [
    ...
    { name: "Imprensa", path: "/admin/acervo/imprensa", icon: Icons.Newspaper },
    ...
    { name: "Transparência viva", path: "/admin/transparencia-viva", icon: Icons.Pulse },
