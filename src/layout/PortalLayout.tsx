  ...
  return (
    <div className="portal-shell min-h-screen bg-bg-page">
      ...
      <a
        ...
        className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-20 focus:z-[100] focus:rounded-lg focus:bg-brand-primary focus:px-6 focus:py-3 focus:text-base focus:font-bold focus:text-white focus:shadow-lg focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-brand-primary"
      >
        Ir para a navegação
      </a>
      <Navbar />
      {!isOnline && (
        <div className="mx-auto w-full max-w-7xl px-4 pt-4 md:px-6" role="status" aria-live="polite">
          <OfflineBanner
            compact
