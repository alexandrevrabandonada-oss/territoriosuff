...
*   **Validação:** O layout da linha de resposta do cache do WebLakes para Retiro foi inspecionado:
    ...
    O parser captura a célula de índice 5 como valor do poluente, o que está correto e perfeitamente alinhado com as outras estações (Belmonte e Santa Cecília).
