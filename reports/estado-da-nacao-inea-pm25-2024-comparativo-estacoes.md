# Estado da Nação — Comparativo de PM2.5 (2024) entre Estações de Volta Redonda
...
| :--- | :---: | :---: | :---: |
| **Leituras Horárias** | 8401h | 8755h | 8643h |
| **Cobertura Anual** | 95.64% | 99.67% | 98.39% |
| **Média Anual** | 11.33 µg/m³ | 9.34 µg/m³ | 8.88 µg/m³ |
| **Comparação Diretriz OMS Anual (5 µg/m³)** | 2.3x | 1.9x | 1.8x |
| **Comparação Padrão CONAMA Anual (10 µg/m³)** | 1.1x | 0.9x | 0.9x |
| **Pico Horário (Max)** | 84.19 µg/m³ | 208.58 µg/m³ | 132.25 µg/m³ |
| **Leituras Zero** | 341h | 521h | 740h |
| **Dias Válidos (≥18h)** | 344 dias | 365 dias | 359 dias |
| **Excedências OMS 24h (>15 µg/m³)** | **77 dias** | **60 dias** | **54 dias** |
| **Excedências CONAMA 506 24h (>25 µg/m³)** | **14 dias** | **11 dias** | **10 dias** |
